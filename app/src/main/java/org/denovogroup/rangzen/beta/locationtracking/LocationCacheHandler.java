...
public class LocationCacheHandler extends SQLiteOpenHelper{
    ...
    private final static String LOG_TAG = "CacheHandler";
    private final static int DATABASE_VERSION = 1;
    private final static String DATABASE_NAME = "RangzenCache.db";
     ...
     *
     * @return cursor object with all the rows in the location cache
     */
    ...
    /** calculating the amount of locations in the cache
     *
     * @return the amount of items in the location cache database
     */
